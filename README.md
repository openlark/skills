...
- [Loop Engineering](./skills/loop-engineering/SKILL.md) - Loop Engineering AI programming paradigm guide. Covers the core concepts of transitioning from single prompt calls to autonomous loop systems, key components, loop patterns, configuration examples, and anti-patterns. 
...
- [Novel Continuation](./skills/novel-continue/SKILL.md) - Continue writing from existing novel content, following the original settings (character relationships, background, personality, plot direction), reasonably introducing new characters and storylines, focusing on detailed descriptions and character psychology, and employing rhetorical techniques to enhance drama. 
- [Novel Polishing](./skills/novel-polish/SKILL.md) - Polish and refine novel text by improving language fluency, emotional expression, and vividness; strengthen story details and imagery; enhance dialogue authenticity; optimize narrative pacing; remove repetition and redundancy. 
...
- [Startup Mentor](./skills/startup-mentor/SKILL.md) - A startup mentor advisor. Provides comprehensive consulting for startups across five dimensions: market positioning, product innovation, marketing strategy, team building, and financial management, delivering practical and actionable recommendations. 
- [OKR Writing](./skills/okr-writer/SKILL.md) - A professional OKR writing assistant. Generates clear and concise OKRs based on work objectives, including Objectives, Key Results, action plans, and timelines, ensuring OKRs are closely aligned with goals and actionable.  
- [Medical Advisor](./skills/medical-advisor/SKILL.md) - A professional medical advisor assistant. Provides health consultations, disease education, medical guidance, and preventive health recommendations to help users understand health issues and establish healthy lifestyles.  
- [Market Research Report Writing](./skills/market-research-report/SKILL.md) - A professional market research report writing assistant. Based on a given topic, outputs a complete market research report covering eight sections: research background, objectives, methodology, market overview, market analysis, competitive analysis, consumer research, and recommendations & strategies. 
- [Market Analysis Report Writing](./skills/market-analysis-report/SKILL.md) - A professional market analysis report writing assistant. Provides industry overview, market status analysis, future trend forecasting, competitive landscape assessment, and consumer behavior research, delivering structured business-professional reports. 
- [Legal Advisor Assistant](./skills/legal-advisor-assistant/SKILL.md) - A professional legal advisor assistant. Provides professional answers and recommendations for legal issues based on the latest statutes, case law, and best practices, including specific solutions and preventive measures. 
- [Job Description Writing](./skills/jd-description-writer/SKILL.md) - A professional job description (JD) writing assistant. Based on job title and recruitment requirements, writes precise, professional, and compelling job descriptions covering three modules: job responsibilities, qualifications, and key skills. 
- [Industry Research Analysis](./skills/industry-research-advisor/SKILL.md) - A senior industry research consultant. Conducts in-depth analysis of specified industries, covering development history, industry trends, competitive landscape, and technological innovation, and outputs forward-looking, actionable recommendations. 
- [Email Writer Assistant](./skills/email-writer-assistant/SKILL.md) - A senior industry research consultant. Conducts in-depth analysis of specified industries, covering development history, industry trends, competitive landscape, and technological innovation, and outputs forward-looking, actionable recommendations. 
